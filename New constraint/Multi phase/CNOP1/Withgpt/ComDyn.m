% Function for repeated computation
function [H1, H2, G1, G2, b1, b2] = ComDyn(vx01, vz01, vx02, vz02, u1_01, u2_01, u1_02, u2_02, sigma, step, m, rho, CD, Sx, Sz, g, sigma2)
    % A_i, B_i, b_i
    A1 = zeros(4,4);
    A1(1,3) = 1;
    A1(2,4) = 1;
    ...
    % H_i, H_i+1, G_i, G_i+1
    H1 = sigma2*B1'*B1 + sigma2*A1'*A1;
    H2 = sigma2*B2'*B2 + sigma2*A2'*A2;

    G1 = sigma2*A1'*B1 + sigma*B1;
    G2 = sigma2*A2'*B2 + sigma*B2;
end
