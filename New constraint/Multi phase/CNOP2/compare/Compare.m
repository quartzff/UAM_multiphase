...
print(h,'conop2_altitude','-dpdf','-r0')
...
pos = get(h,'Position');
set(h,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(h,'conop2_alongspeed','-dpdf','-r0')
...
pos = get(h,'Position');
set(h,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(h,'conop2_verticalspeed','-dpdf','-r0')
% % % u1 vs. t
% % figure
% % 
