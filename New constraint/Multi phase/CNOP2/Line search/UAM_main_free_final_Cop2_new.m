...
% %     Sigma2_all(:,Index+1) = sigma2_opt;
    ...
    Xk1 = Xk;
    Uk1 = Uk;
    sig1 = ones(col_points+col_points2,1)*sigma;%change 1x1 variable to 1xn vector
    sig2 = ones(col_points+col_points2,1)*sigma2;
    Zk1 = [Xk1; Uk1; sig1';sig2'];%solution pair from last iteration
    
    Uk2 = U_opt;
    Xk2 = X_opt;
    sig1_2 = ones(col_points+col_points2,1)*sigma_opt;
    sig2_2 = ones(col_points+col_points2,1)*sigma2_opt;
    Zk2 = [Xk2; Uk2; sig1_2';sig2_2'];%solution pair from new iteration
    c = 1;
...
%     etak2 = etak1 + c*(etak2 - etak1); % updated eta_k, 1*N
    sig1_2   = sig1 + c*(sig1_2 - sig1); % updated s_k, 1*N
    sig2_2   = sig2 + c*(sig2_2 - sig2);
    Zk2   = [Xk2; Uk2; sig1_2';sig2_2']; % updated Z_k, 8*N
    
    State_all(:,Index+1) = [Xk2(1,:), Xk2(2,:), Xk2(3,:), Xk2(4,:)];
    Control_all(:,Index) = [Uk2(1,:), Uk2(2,:), Uk2(3,:)];
    Sigma_all(:,Index+1) = sig1_2(1,1);
    Sigma2_all(:,Index+1) = sig2_2(1,1);
